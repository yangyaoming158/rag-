...
最近更新：2026-06-12（初始化，尚未开工）

## 阶段总览

| Phase | 内容 | 状态 | 完成日期 | 规划文档 | 备注 |
|---|---|---|---|---|---|
| 前置 | mini-mall Phase 3 收尾验收 | ⬜ | — | — | RAG 编码的前置条件 |
| 0 | 初始化：3 容器 Compose + Flyway V1 + 前后端骨架 | ⬜ | — | docs/plans/phase-0.md | |
| 1 | KB CRUD + 上传落盘 + 文档列表/状态/删除 | ⬜ | — | docs/plans/phase-1.md | |
